...
def home(request):
	return render(request, 'rizocciupgradeapp/index.html')

def plans(request):
	return render(request, 'rizocciupgradeapp/investment-plans.html')

def news(request):
	return render(request, 'rizocciupgradeapp/news.html')

def aml(request):
	return render(request, 'rizocciupgradeapp/aml.html')

def who(request):
	return render(request, 'rizocciupgradeapp/who.html')

def what(request):
	return render(request, 'rizocciupgradeapp/what.html')

def approach(request):
	return render(request, 'rizocciupgradeapp/approach.html')

def investors(request):
	return render(request, 'rizocciupgradeapp/investors.html')

def how(request):
	return render(request, 'rizocciupgradeapp/how.html')

def nfp(request):
	return render(request, 'rizocciupgradeapp/nfp.html')

def faq(request):
	return render(request, 'rizocciupgradeapp/faq.html')

def otherpayment(request):
    return render(request, 'rizocciupgradeapp/otherpayment.html')


def about(request):
	return render(request, 'rizocciupgradeapp/company.html')


def career(request):
	return render(request, 'rizocciupgradeapp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('rizocciupgradeapp/loginAlert2.html', {'name':username})
	...
	context={}
	return render(request, 'rizocciupgradeapp/login.html')


def privacy(request):
	return render(request, 'rizocciupgradeapp/privacy.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'rizocciupgradeapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('rizocciupgradeapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('rizocciupgradeapp/welcomeEmail2.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
			'Welcome to Bitprintinvestmentservice',
			plain_message,
			settings.EMAIL_HOST_USER,
			[email],
		...
		second_template= render_to_string('rizocciupgradeapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		second_plain_message= strip_tags(second_template)
		second_email_message= EmailMultiAlternatives(
			"Stay updated and discover more with Bitprintinvestmentservice!",
		...
		try:
			send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['support@Bitprintinvestmentservice.com'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'rizocciupgradeapp/register.html', context)
...
def dashboard(request):
	...
	return render(request, 'rizocciupgradeapp/dashboard.html', context)
...
def admindashboard(request):
	...
	return render(request, 'rizocciupgradeapp/adminpage.html', context)


def terms(request):
	return render(request, 'rizocciupgradeapp/terms.html')


def realestate(request):
	return render(request, 'rizocciupgradeapp/realestate.html')


def crypto(request):
	return render(request, 'rizocciupgradeapp/crypto.html')


def forex(request):
	return render(request, 'rizocciupgradeapp/forex.html')


def nft(request):
	return render(request, 'rizocciupgradeapp/nft.html')


def contact(request):
	return render(request, 'rizocciupgradeapp/contact.html')


def stocks(request):
	return render(request, 'rizocciupgradeapp/stocks.html')


def agriculture(request):
	return render(request, 'rizocciupgradeapp/agriculture.html')


def gold(request):
	return render(request, 'rizocciupgradeapp/gold.html')


def retirement(request):
	return render(request, 'rizocciupgradeapp/retirement.html')
...
def deposit(request):
	if request.method=='POST':
		...
		if price_amount and pay_currency:
			...
			template= render_to_string('rizocciupgradeapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@quantumfinancecompany.com'])
			except BadHeaderError:
				pass
			return redirect(generated_link)
	context={}
	return render(request, 'rizocciupgradeapp/deposit.html', context)
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['support@Bitprintinvestmentservice.com'])
	...
	context={}
	return render(request, 'rizocciupgradeapp/withdrawal.html', context)
...
def history(request):
	...
	return render(request, 'rizocciupgradeapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'rizocciupgradeapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'rizocciupgradeapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'rizocciupgradeapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'rizocciupgradeapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'rizocciupgradeapp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'rizocciupgradeapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('rizocciupgradeapp/withdrawalEmail2.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('rizocciupgradeapp/declineWithdrawalEmail2.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'rizocciupgradeapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	if float(payment_info_investment_plan) == float(0.015):
		packageName= 'Basic Package'
	if float(payment_info_investment_plan) == float(0.03):
		packageName= 'Classic Package'
	if float(payment_info_investment_plan) == float(0.06):
		packageName= 'Professional Package'
	if float(payment_info_investment_plan) == float(0.1):
		packageName= 'Advanced Professional Package'
	template= render_to_string('rizocciupgradeapp/confirmDepositEmail2.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'rizocciupgradeapp/account_settings.html', context)
...
def create_bonus(request):
	...
	if form.is_valid():
		...
		template= render_to_string('rizocciupgradeapp/bonusNotification.html', {'message':message, 'amount':amount, 'code':code})
		plain_message= strip_tags(template)
		emailmessage= EmailMultiAlternatives(
		...
		emailmessage.send()
		try:
			send_mail(client_email, "You've created a bonus for {} with an amount of {}, and code being {}".format(client_email, amount, code),settings.EMAIL_HOST_USER, ['info@quantumfinancecompany.com'])
		except BadHeaderError:
			pass
		return HttpResponse('You have successfully created a Bonus for your client')
	context={'form': form}
	return render(request, 'rizocciupgradeapp/create_bonus.html', context)
	...
	if request.method == 'POST':
		...
		if payment_code:
			...
			if check_payment_code:
				...
				template= render_to_string('rizocciupgradeapp/bonusComplete.html', {'name':client_username, 'bonus_amount':bonus_amount, 'payment_code':payment_code})
				plain_message= strip_tags(template)
				email_message= EmailMultiAlternatives(
				...
				email_message.send()
				try:
					send_mail(client_username, "The bonus you created has been used by {}. They recieved an amount of {}. ".format(client_username, bonus_amount),settings.EMAIL_HOST_USER, ['info@quantumfinancecompany.com'])
				except BadHeaderError:
					pass
		...
		print(payment_code)
	context={}
	return render(request, 'rizocciupgradeapp/use_bonus.html', context)
...
def meetrobert(request):
	...
	context={}
	return render(request, 'rizocciupgradeapp/meetrobert.html', context)
...
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('rizocciupgradeapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
